/* Global Variables form01 and icons*/
const form = document.querySelector('.form01');
const icons = document.querySelectorAll('.iconform');

// Base URL and API Key for OpenWeatherMap API Global Free API
...
req.headers({
  "x-rapidapi-key": "a28f4540b8mshdf1ce1d5753340dp178f03jsn614846c23b7a",
